...
class ProblemSolveHistoryTest {
     ...
     *             user_id ) problemsol0_
     *     order by
     *         problemsol0_.total_count desc,
     *         problemsol0_.hard_count desc,
     *         problemsol0_.medium_count desc,
     *         problemsol0_.easy_count desc
     * =========================================================After find all
     *
     * order by added
     */
    ...
    void findAllAndOrderTest() {
        System.out.println("=========================================================Before find all");
        problemSolveHistoryRepository.findAllByOrderByTotalCountDescHardCountDescMediumCountDescEasyCountDesc();
        System.out.println("=========================================================After find all");
    }
